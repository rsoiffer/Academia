        ...
        for (Entry<Vec3d, Integer> e : colors.entrySet()) {
            ...
            for (Vec3d dir : DIRS) {
                if (!colors.containsKey(e.getKey().add(dir))) {
                    ...
                    if (dir.x != 0) {
                        RMB.addRectangle(new Vec3d(x0, y0, z0), new Vec3d(0, 1, 0), new Vec3d(0, 0, 1));
                    }
                    if (dir.y != 0) {
                        RMB.addRectangle(new Vec3d(x0, y0, z0), new Vec3d(1, 0, 0), new Vec3d(0, 0, 1));
                    }
                    if (dir.z != 0) {
                        RMB.addRectangle(new Vec3d(x0, y0, z0), new Vec3d(1, 0, 0), new Vec3d(0, 1, 0));
                    }
                }
            }
        }
